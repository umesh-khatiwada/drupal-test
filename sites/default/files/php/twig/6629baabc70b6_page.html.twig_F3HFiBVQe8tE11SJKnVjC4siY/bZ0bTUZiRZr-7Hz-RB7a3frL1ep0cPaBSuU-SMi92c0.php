...
class __TwigTemplate_a8b72e5606ccdfa8cca20c2fd2ada9b1 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["theme", "page", "navbar_attributes", "content_attributes"]);    }
    ...
    public function block_navbar($context, array $blocks = [])
    {
        ...
        echo "    ";
        // line 59
        $context["navbar_classes"] = ["navbar", ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 61
...
($context["theme"] ?? null), "settings", [], "any", false, false, true, 62), "navbar_position", [], "any", false, false, true, 62)) ? (("navbar-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "settings", [], "any", false, false, true, 62), "navbar_position", [], "any", false, false, true, 62), 62, $this->source)))) : (($context["container"] ?? null)))];
        // line 65
        echo "    <header";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["navbar_attributes"] ?? null), "addClass", [($context["navbar_classes"] ?? null)], "method", false, false, true, 65), 65, $this->source), "html", null, true);
      ...
      ";
        ...
        // line 88
        echo "      ";
        if ( !twig_get_attribute($this->env, $this->source, ($context["navbar_attributes"] ?? null), "hasClass", [($context["container"] ?? null)], "method", false, false, true, 88)) {
            // line 89
            echo "        </div>
      ";
        }
  ...
  ";
    ...
    <div class=\"row\">
      ...
      ";
        ...
        echo "      ";
        // line 120
        $context["content_classes"] = [(((twig_get_attribute($this->env, $this->source,         // line 121
($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 121) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 121))) ? ("col-sm-6") : ("")), (((twig_get_attribute($this->env, $this->source,         // line 122
($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 122) && twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 122)))) ? ("col-sm-9") : ("")), (((twig_get_attribute($this->env, $this->source,         // line 123
($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 123) && twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 123)))) ? ("col-sm-9") : ("")), (((twig_test_empty(twig_get_attribute($this->env, $this->source,         // line 124
($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 124)) && twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 124)))) ? ("col-sm-12") : (""))];
        // line 127
        echo "      <section";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [($context["content_classes"] ?? null)], "method", false, false, true, 127), 127, $this->source), "html", null, true);
        echo ">
...
";
  ...
  ";
    ...
    {
        return array (  327 => 165,  322 => 164,  318 => 163,  311 => 154,  308 => 153,  304 => 152,  298 => 146,  295 => 145,  291 => 144,  284 => 139,  280 => 138,  273 => 132,  269 => 131,  262 => 113,  259 => 112,  255 => 111,  248 => 104,  245 => 103,  241 => 102,  235 => 158,  232 => 157,  229 => 152,  226 => 151,  222 => 148,  219 => 144,  216 => 142,  213 => 141,  210 => 138,  207 => 137,  204 => 135,  201 => 134,  198 => 131,  195 => 130,  189 => 127,  187 => 124,  186 => 123,  185 => 122,  184 => 121,  183 => 120,  181 => 119,  178 => 117,  175 => 116,  172 => 111,  169 => 110,  166 => 108,  163 => 107,  160 => 102,  157 => 101,  150 => 97,  146 => 96,  141 => 91,  137 => 89,  134 => 88,  128 => 85,  125 => 84,  122 => 83,  118 => 80,  109 => 74,  106 => 73,  103 => 72,  99 => 70,  96 => 69,  90 => 67,  88 => 66,  83 => 65,  81 => 62,  80 => 61,  79 => 59,  77 => 58,  73 => 57,  66 => 163,  64 => 162,  61 => 161,  59 => 96,  56 => 94,  52 => 57,  50 => 56,  48 => 54,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/bootstrap/templates/system/page.html.twig", "/Users/umeshkhatiwada/Umesh/Company/BerryBytes/drupal-test/themes/bootstrap/templates/system/page.html.twig");
    }
