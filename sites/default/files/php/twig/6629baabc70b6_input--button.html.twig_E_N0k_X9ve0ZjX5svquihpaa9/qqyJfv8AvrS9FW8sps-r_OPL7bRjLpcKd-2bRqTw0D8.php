...
class __TwigTemplate_eb5d3d072f2754bee1fc4b45b4ce9b66 extends Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
        ...
        if ((($context["icon"] ?? null) && ($context["icon_only"] ?? null))) {
            // line 34
            echo "      <button";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null), "icon-only"], "method", false, false, true, 34), 34, $this->source), "html", null, true);
            echo ">
        <span class=\"sr-only\">";
            // line 35
    ...
    ";
            ...
            if ((($context["icon_position"] ?? null) == "after")) {
                // line 40
                echo "        <button";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 40), 40, $this->source), "html", null, true);
                echo ">";
  ...
  ";
    ...
    {
        return array (  112 => 25,  106 => 45,  103 => 44,  92 => 42,  81 => 40,  78 => 39,  72 => 36,  68 => 35,  63 => 34,  60 => 33,  58 => 30,  57 => 29,  56 => 27,  54 => 26,  49 => 25,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/Users/umeshkhatiwada/Umesh/Company/BerryBytes/drupal-test/themes/bootstrap/templates/input/input--button.html.twig");
    }
