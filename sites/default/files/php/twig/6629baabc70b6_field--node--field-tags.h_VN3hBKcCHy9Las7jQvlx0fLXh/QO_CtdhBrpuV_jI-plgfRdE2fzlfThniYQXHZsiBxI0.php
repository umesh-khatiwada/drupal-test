...
class __TwigTemplate_7cc7fb41ac663d4df90c1b35c2a5f865 extends Template
{
    private $source;
    private $macros = [];
...
<div";
  ...
  ";
        ...
        if ( !($context["label_hidden"] ?? null)) {
            // line 43
            echo "    <h3";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [($context["title_classes"] ?? null)], "method", false, false, true, 43), 43, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "core/themes/olivero/templates/field/field--node--field-tags.html.twig", "/home/umesh-khatiwada/Desktop/drupal-test/core/themes/olivero/templates/field/field--node--field-tags.html.twig");
    }
