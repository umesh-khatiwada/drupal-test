...
class __TwigTemplate_65d39528720fbb7b05e7d34f027ebaf7 extends Template
{
    private $source;
    private $macros = [];
...
($context["disabled"] ?? null)) ? ("is-disabled") : (""))];
    ...
    ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 39)) {
                // line 40
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 40), "addClass", [($context["description_classes"] ?? null)], "method", false, false, true, 40), 40, $this->source), "html", null, true);
                echo ">";
...
";
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/form/field-multiple-value-form.html.twig", "/home/umesh-khatiwada/Desktop/drupal-test/core/themes/olivero/templates/form/field-multiple-value-form.html.twig");
    }
