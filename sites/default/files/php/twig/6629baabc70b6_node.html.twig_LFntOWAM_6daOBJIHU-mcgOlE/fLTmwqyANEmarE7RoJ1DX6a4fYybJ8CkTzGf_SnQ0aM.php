...
class __TwigTemplate_2a109bfdaf5b8af24a920d4cb202a139 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
    ...
    ";
      ...
      ";
        ...
        if ((($context["label"] ?? null) &&  !($context["page"] ?? null))) {
            // line 87
            echo "      <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["node__title"], "method", false, false, true, 87), 87, $this->source), "html", null, true);
            echo ">
        <a href=\"";
            // line 88
  ...
  <div";
        // line 106
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["node__content", ($context["layout"] ?? null)], "method", false, false, true, 106), 106, $this->source), "html", null, true);
        echo ">
    ";
        // line 108
        echo "    ";
...
";
    ...
    {
        return new Source("", "core/themes/olivero/templates/content/node.html.twig", "/home/umesh-khatiwada/Desktop/drupal-test/core/themes/olivero/templates/content/node.html.twig");
    }
